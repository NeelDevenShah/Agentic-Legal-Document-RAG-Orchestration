# RAG Benchmark Evaluation Results Summary (Experiment 3: Optimized LangGraph Pipeline)

## Aggregate Metrics

| Metric | LangGraph Flow (Optimized) | DeepAgents Flow |
|---|---|---|
| **Accuracy Pass Rate (Score >= 7)** | **100.0%** (50/50) | **86.0%** (43/50) |
| **Mean Accuracy Score (0-10)** | **9.28** | **8.28** |
| **Mean Citation Score (0-10)** | **8.68** | **7.84** |
...
| 2 | In Facebook, Inc. v. Amalgamated Bank, when was the judgment of t... | 10.0 | 1.61s | 7.0 | 24.73s |
...
| 12 | What does Section 13(a) of the Exchange Act require issuers to fi... | 10.0 | 1.99s | 9.0 | 21.22s |
...
| 16 | In the legal briefs, which editions of the Restatement of Contrac... | 10.0 | 2.16s | 5.0 | 32.90s |
| 17 | Why does Knight argue that it is entitled to summary judgment in ... | 10.0 | 2.53s | 9.0 | 24.12s |
...
| 22 | What disclosures must a fund include in its next shareholder repo... | 10.0 | 2.16s | 5.0 | 91.16s |
...
| 26 | What conduct does the Commission allege Chiueh engaged in that vi... | 10.0 | 2.66s | 9.0 | 33.23s |
...
| 37 | In Facebook, Inc. et al. v. Amalgamated Bank et al., who are the ... | 10.0 | 2.10s | 5.0 | 26.05s |
| 38 | What conduct did the Commission allege that Defendants engaged in... | 10.0 | 1.93s | 3.0 | 21.85s |
